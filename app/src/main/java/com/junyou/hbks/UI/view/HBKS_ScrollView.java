package com.junyou.hbks.UI.view;
...
public class HBKS_ScrollView extends ScrollView {
    ...
    public HBKS_ScrollView(Context context) {
        super(context);
    }

    public HBKS_ScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
